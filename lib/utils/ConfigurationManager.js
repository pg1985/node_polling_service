...
ConfigurationManager.prototype.getGPlusAppID = function () {
  return process.env['GPLUS_APP_ID'] || "1033890060020-60002h7ptdn9p8t04l3d6cv3uk7kicij.apps.googleusercontent.com";
};

ConfigurationManager.prototype.getGPlusAppSecret = function () {
  return process.env['GPLUS_SECRET'] || "cfuqaWtDmiEPBzSoTr-GE_Gu";
};

ConfigurationManager.prototype.getGPlusApiKey = function () {
  return "AIzaSyAD9jJGCts_PZQCcHaF6SZYOLsqeIQNkoo";
}
